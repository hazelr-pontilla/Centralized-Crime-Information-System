...
namespace App\Filament\Resources\VictimResource\RelationManagers;
...
class VictimRelationManager extends RelationManager
{
    protected static string $relationship = 'victim';
                    ...
                    ->schema([
                        ...
                        Forms\Components\Grid::make(5)
                            ->schema([
                                ...
                                Forms\Components\TextInput::make('v_townn')
                                    ->label('TOWN/CITY'),
